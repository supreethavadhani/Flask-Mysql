    ...
    try:
            ...
            for sec in sectors:
                sect_dict = {
                        ...
                        'State': sec[3],
                        'Rain':sec[4] }
                sectors_dict.append(sect_dict)

            return json.dumps(sectors_dict)
    except Exception as e:
        return render_template('error.html', error = str(e))
